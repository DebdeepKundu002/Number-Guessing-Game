...
public class Game extends JFrame {
    ...
    public Game() {
        ...
        // System.out.printf("Round %d: Guess the number between %d and %d in %d
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (attempts < MAX_ATTEMPTS) {
                    ...
                    if (guess_number == number) {
                        ...
                        output1blb.setText("Hurray! Number Guessed Successfully. Attempts = " + score
                                + ". Round Score = " + score);
                        ...
                        if (i < MAX_ROUNDS) {
                            ...
                            roundlbl.setText("Round " + i + ": Guess the number between " + MIN_RANGE + " and "
                                    + MAX_RANGE + " in " + MAX_ATTEMPTS + " attempts.");
                        ...
                        output1blb.setText("The number is greater than " + guess_number
                                + ". Try Again. Attempts Left = " + (MAX_ATTEMPTS - attempts) + ".\n");
                        inputtxt.setText("");
                    }

                    else if (guess_number > number) {
                        output1blb.setText("The number is less than " + guess_number + ". Try Again.  Attempts Left = "
        ...
        roundlbl.setText("Round " + i + ": Guess the number between " + MIN_RANGE + " and " + MAX_RANGE + " in "
                + MAX_ATTEMPTS + " attempts.");
    }
}